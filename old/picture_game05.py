...
# Example of how to access the data for a category and the images
#for i, category in enumerate(categories):
#    category_name = category["name"]
#    image_files = category["image_files"]
#    print(f"Category {i+1}: {category_name}")
#    for image_file in image_files:
#        print("Image file:", os.path.join(images_path, image_file))
            ...
            for i, category in enumerate(categories):
                for j, value in enumerate([200, 400, 600, 800, 1000]):
                    ...
                    if box_rect.collidepoint(mouse_pos):
                        try:
                            #image = pygame.image.load(categories[i]['image_files'][j])
